...
/*** @Title: EsController* @Description:* @author chy* @date 2018/8/13 11:13*/
@RestController
@RequestMapping("/es")
public class ESController {
    ...
    public String createIndex(HttpServletRequest request, HttpServletResponse response) throws IOException {
